...
export default function ItemForm() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      try {
        ...
        setErr(`Photo upload failed: ${uploadError?.message || uploadError}`);
        return;
      }
  ...
  return (
    <section className="mx-auto max-w-3xl">
      ...
      <div
        className="relative overflow-hidden rounded-3xl border bg-white p-6 shadow-[0_10px_30px_rgba(0,0,0,.06)] sm:p-8"
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <label className="block">
              ...
              <input
                ...
                className="w-full rounded-xl border bg-white px-3 py-2 text-sm shadow-sm outline-none focus:ring-2 focus:ring-[rgba(11,44,92,0.55)]"
                style={{ borderColor: "rgba(11,44,92,0.18)" }}
              />
            ...
            <div className="block">
              ...
              >
                <input
                  ...
                  accept="image/*"
                  required
                  className="w-full text-sm outline-none file:mr-3 file:rounded-md file:border-0 file:bg-gray-100 file:px-3 file:py-1.5 file:text-sm file:font-semibold hover:file:bg-gray-200"
                  onChange={(e) => {
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-center gap-2">
                <button
                  type="submit"
                  disabled={submitting}
                  className="rounded-xl px-4 py-2 text-sm font-semibold text-white shadow-md transition hover:opacity-95 disabled:cursor-not-allowed disabled:opacity-60"
                ...
                <button
                  ...
                  disabled={submitting}
                  className="rounded-xl border px-4 py-2 text-sm font-semibold transition hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-60"
                  style={{
